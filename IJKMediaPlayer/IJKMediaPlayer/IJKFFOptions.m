...
@implementation IJKFFOptions {
    ...
    NSMutableDictionary *_commOptions;
}
...
+ (IJKFFOptions *)optionsByDefault
{
    ...
    //支持播放本地m3u8
    [options setFormatOptionValue:@"file,crypto,hls,mpegts,http,tcp" forKey:@"protocol_whitelist"];
    [options setFormatOptionIntValue:0                  forKey:@"auto_convert"];
    //[options setFormatOptionIntValue:1                  forKey:@"reconnect"];
    //[options setFormatOptionIntValue:25000 forKey:@"formatprobesize"];
    //[options setFormatOptionIntValue:200000 forKey:@"probesize"];
    //[options setFormatOptionIntValue:1500000 forKey:@"analyzeduration"];
...
- (void)applyTo:(IjkMediaPlayer *)mediaPlayer
{
    ...
    //ijkmp_set_log_reportdb(mediaPlayer, 1);
}

...
typedef NS_OPTIONS(NSUInteger, IJKMPMovieLoadState) {
    ...
    IJKMPMovieLoadStateTimeout        = 1 << 3, // playback load timeout
};

typedef NS_ENUM(NSInteger, IJKMPMovieFinishReason) {
    IJKMPMovieFinishReasonPlaybackEnded,
    IJKMPMovieFinishReasonPlaybackSeekEnded,
...
//whether to autoplay when loading end, default is autoplay 
